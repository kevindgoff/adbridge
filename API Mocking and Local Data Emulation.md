...
- **Data Integration:** Ensure the API service utilizes the database as the single source of truth for all dynamic responses.
...
- **Schema Mapping:** The schema of this database is not really important, its just a cache of test data to returned.  AI is generating a simple relational structure (e.g., `Users`, `Accounts`, `Transactions`) based on the most common objects in the Basis documentation.
